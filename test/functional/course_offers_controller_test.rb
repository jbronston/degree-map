...
class CourseOffersControllerTest < ActionController::TestCase
  ...
  test "should create course_offer" do
    assert_difference('CourseOffer.count') do
      post :create, course_offer: { course_id: @course_offer.course_id, instructor: @course_offer.instructor, year: @course_offer.year }
    end
  ...
  test "should update course_offer" do
    put :update, id: @course_offer, course_offer: { course_id: @course_offer.course_id, instructor: @course_offer.instructor, year: @course_offer.year }
    assert_redirected_to course_offer_path(assigns(:course_offer))
  end
