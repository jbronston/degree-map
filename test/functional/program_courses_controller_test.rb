...
class ProgramCoursesControllerTest < ActionController::TestCase
  ...
  test "should create program_course" do
    assert_difference('ProgramCourse.count') do
      post :create, program_course: { course_id: @program_course.course_id, prerequisite_cid: @program_course.prerequisite_cid, program_id: @program_course.program_id }
    end
  ...
  test "should update program_course" do
    put :update, id: @program_course, program_course: { course_id: @program_course.course_id, prerequisite_cid: @program_course.prerequisite_cid, program_id: @program_course.program_id }
    assert_redirected_to program_course_path(assigns(:program_course))
  end
